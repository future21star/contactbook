...
class Background
  ...
  def perform(prs_temp)
   ...
   # #  csv_string = _params[:datafile].read
   # #  debugger
   ...
   #  @@download = @new_pos + @unpushed_items
    ...
    #   :template => 'home/success',
    #   :layout => 'application',
    # )
    render :template => 'home/success', :layout => 'application'
  end

  def build_html
    html = render :template => 'home/success',
                  :layout => 'application'
    html
  end
